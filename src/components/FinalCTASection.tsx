...
const FinalCTASection = () => {
  return <section className="py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full opacity-20" style={{
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          delay: 0.1
            ...
            <span className="text-gradient">Make it invincible.</span>
          </motion.h2>
